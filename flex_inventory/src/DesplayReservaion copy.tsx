...
const ReservationDisplay = () => {
  ...
  useEffect(() => {
    fetch(`${API_BASE_URL}/reservations/${params.id}`)
      .then((res) => res.json())
      .then((data) => {
        setData(data);
      })
  ...
  const handlePrintPDF = async () => {
    ...
    return (
      ...
      //         className="cursor-pointer flex-1 bg-blue-600 text-white py-3 rounded-lg font-semibold hover:bg-blue-700 transition duration-200"
      //       >
      //         Print Reservation
      //       </button>
      ...
      <div className="p-6 max-w-3xl mx-auto">
        <div id="pdf-content" className="bg-white rounded-lg shadow p-6">
          ...
          <div className="mb-6">
            ...
            <p>
              <strong>Driver License/ID:</strong> {data?.driverLicense}
            </p>
            <p>
          ...
          <div className="mb-6">
            ...
            <p>
              <strong>Truck Number:</strong> {data?.truckNumber}
            </p>
            <p>
              <strong>Trailer Number:</strong> {data?.trailerNumber}
            </p>
          </div>
